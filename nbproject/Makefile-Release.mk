...
${OBJECTDIR}/InputFactory.o: InputFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/home/tobias/dev/GRAPES/include -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputFactory.o InputFactory.cpp

${OBJECTDIR}/InputFfmpeg.o: InputFfmpeg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/home/tobias/dev/GRAPES/include -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputFfmpeg.o InputFfmpeg.cpp
